                    ...
                    boards.length > 0 && boards.map((board, index) => {
                        return (
                            <DndItem onDrop={onUpdateUser} setDisableDrag={setDisableDrag} disableDrag={disableDrag} type='board' Component='div' key={board._id} onDrag={handleDragItems} _id={board._id} index={index} items={boards} setItems={setBoards} >
                                <Board img={board.img} setDisableDrag={setDisableDrag} setIsPopupWithFormOpen={setIsPopupWithFormOpen} setIsDeletePopOpen={setIsDeletePopOpen} setBoardId={setBoardId} id={board._id} title={board.title} onDelete={onDelete} />
                            </DndItem>
                        )
                    })
                }
